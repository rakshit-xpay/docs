...
These statuses help in tracking the lifecycle of a subscription from creation to cancellation or inactivity. Now, you can explore [subscription endpoints](../endpoint/xPayAPIs/create-subscription) to integrate your subscription. 
