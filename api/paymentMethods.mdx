...
xPay supports a wide range of payment methods to ensure global compatibility. By default, **Cards** are enabled. You can contact us to activate additional payment methods based on your business needs.
...
xPay Supports the following payment methods. **Cards** are kept on by default. Kindly reach out to us to enable other payment methods.

| **Category**         | **Payment Methods**                                                                                             |
|----------------------|-----------------------------------------------------------------------------------------------------------------|
| **Cards (Default)**  | Visa, Mastercard, American Express, Discover, and more                                                          |
...
- **Cards (Default)**: This is the default payment method enabled for all xPay accounts. You can accept payments from major credit and debit cards such as Visa, Mastercard, American Express, and Discover.
...
<Note>
To activate any of these payment methods, please reach out to us at [hello@xpaycheckout.com](mailto:hello@xpaycheckout.com).
</Note>
