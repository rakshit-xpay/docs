---
title: "Completed"
description: "This event is triggered when a subscription is successfully completed after all billing cycles."
---

<ResponseExample>
```json
{
  "eventId": "67543b151a8e8b7dcf93242",
  "eventType": "subscription.completed",
  "eventTime": 1729608043615,
  "subscriptionId": "67543b151a8e8b7dcf94543",
  "status": "COMPLETED",
  "amount": 2000,
  "currency": "USD",
  "cycleCount": 12,
...
<ResponseField name="eventId" type="string">
  ...
  of the currency. Here, `2000` represents 20.00 USD.{" "}
  ...
  is `MONTH` and `intervalCount` is `1`, the subscription was billed monthly.{" "}
